...
const dict: Record<string, { en: string; ru: string }> = {
  ...
  Завершити: { en: 'Finish', ru: 'Завершить' },
  'У дорозі': { en: 'Riding now', ru: 'В пути' },
  'Новий маршрут': { en: 'New route', ru: 'Новый маршрут' },
  'Мої маршрути': { en: 'My routes', ru: 'Мои маршруты' },
  'Назва маршруту': { en: 'Route name', ru: 'Название маршрута' },
  Звідки: { en: 'From', ru: 'Откуда' },
  Куди: { en: 'To', ru: 'Куда' },
  'Створити маршрут': { en: 'Create route', ru: 'Создать маршрут' },
  'Вкажіть назву маршруту': { en: 'Enter a route name', ru: 'Укажите название маршрута' },
  збережено: { en: 'saved', ru: 'сохранён' },
